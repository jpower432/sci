...
#ArtifactType: "ControlCatalog" | "GuidanceCatalog" | "ThreatCatalog" | "RiskCatalog" | "CapabilityCatalog" | "Policy" | "MappingDocument" | "EvaluationLog" | "EnforcementLog" | "VectorCatalog" @go(-)
