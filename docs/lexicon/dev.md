...
**Version**: <span class="badge badge-version">dev</span>

The Gemara lexicon establishes stable definitions for compliance activities,
describes their interactions, and provides standards for term usage.
...
| **Assessment Plan** | An outline of criteria for conducting assessments to verify that an applicable assessment requirement is being met within the scope of a policy. | Layer 3 |   |
...
| **Residual Risk** | Inherent Risk is the level of risk before any controls or mitigation efforts are applied. |   |   |
| **Residual Risk** | Residual Risk is the risk that remains after security controls have been implemented. |   |   |
